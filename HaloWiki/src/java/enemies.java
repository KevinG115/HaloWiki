 ...
 * @author Kev
 */
@WebServlet(name = "enemies", urlPatterns = {"/enemies"})
public class enemies extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            String XMLFileName = path + "/enemies.xml";
            String XSLFileName = path + "/enemies.xsl";
